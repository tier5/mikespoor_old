...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
            ...
            <form action="<?php echo DOMAIN.'backend/link-news/editcms'; ?>" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="hid_gallery_pdf1" id="hid_gallery_pdf1" value="<?php if(isset($bannerinfo['cms_image'])){echo $bannerinfo['cms_image'];} ?>" />
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="<?php if(!empty($bannerinfo['cms_image'])){echo DOMAIN.'uploads/'.$bannerinfo['cms_image'];} ?>" id="profile" width="200" height="80"/>
