...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
            ...
            <form action="<?php echo DOMAIN.'backend/banner/editbanner'; ?>" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="hid_gallery_pdf1" id="hid_gallery_pdf1" value="<?php if(isset($bannerinfo['banner_image'])){echo $bannerinfo['banner_image'];} ?>" />
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="<?php if(!empty($bannerinfo['banner_image'])){echo DOMAIN.'assets/required/'.$bannerinfo['banner_image'];} ?>" id="profile" width="200" height="80"/>
