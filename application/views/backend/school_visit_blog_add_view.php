...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
			...
			{
			?>
            <form action="<?php echo DOMAIN.'backend/school_visit_blog/addbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			else if($feature=='Edit')
			{
			?>
            <form action="<?php echo DOMAIN.'backend/school_visit_blog/editbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <select class="form-control select2" name="selCategory" id="selCategory">
                  ...
                  <p class="help-block" style="font-size:12px;"><i><a href="<?php echo DOMAIN.'backend/school_visit_blog/add'; ?>">Click here</a> to add new category.</i></p>
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">Image</label>
                  <input type="file" id="prfbtn" name="imgBanner"><br/>
                  <img src="<?php if(isset($bannerinfo['gschool_visit_blog_image'])){echo DOMAIN.'uploads/'.$bannerinfo['gschool_visit_blog_image'];} ?>" id="profile" width="200" height="80"/>
			...
			?>
                ...
                <button type="submit" class="btn btn-primary" value="new" name="btnAdd">Save and Add New</button>
                 <a class="btn btn-default" href="<?php echo DOMAIN.'backend/school_visit_blog'; ?>">Back To List</a>
                  <?php
			}
			else if($feature=='Edit')
			{
