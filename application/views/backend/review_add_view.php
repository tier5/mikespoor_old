...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
			...
			{
			?>
            <form action="<?php echo DOMAIN.'backend/review/addbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			else if($feature=='Edit')
			{
			?>
            <form action="<?php echo DOMAIN.'backend/review/editbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			?>
             ...
             <input type="hidden" name="hid_image" id="hid_image" value="<?php if(isset($bannerinfo['review_image'])){echo $bannerinfo['review_image'];} ?>" />
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="<?php if(isset($bannerinfo['review_image'])){echo DOMAIN.'uploads/'.$bannerinfo['review_image'];} ?>" id="profile" width="100" height="80"/>
			...
			?>
                ...
                <button type="submit" class="btn btn-primary" value="new" name="btnAdd">Save and Add New</button>
                 <a class="btn btn-default" href="<?php echo DOMAIN.'backend/review'; ?>">Back To List</a>
                  <?php
			}
			else if($feature=='Edit')
			{
