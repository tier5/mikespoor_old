...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
			...
			{
			?>
            <form action="<?php echo DOMAIN.'backend/about_us/addnewtimeline'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			else if($feature=='Edit')
			{
			?>
            <form action="<?php echo DOMAIN.'backend/about_us/editnewtimeline'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			?>
			...
			?>
                ...
                <button type="submit" class="btn btn-primary" value="new" name="btnAdd">Save and Add New</button>
                 <a class="btn btn-default" href="<?php echo DOMAIN.'backend/about_us/timeline'; ?>">Back To List</a>
                  <?php
			}
			else if($feature=='Edit')
			{
