...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
			...
			{
			?>
            <form action="<?php echo DOMAIN.'backend/home_page/addbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			else if($feature=='Edit')
			{
			?>
            <form action="<?php echo DOMAIN.'backend/home_page/editbanner'; ?>" method="post" enctype="multipart/form-data">
            <?php
			}
			?>
            ...
            <input type="hidden" name="hid_gallery_pdf2" id="hid_gallery_pdf2" value="<?php if(isset($bannerinfo['banner_front_image'])){echo $bannerinfo['banner_front_image'];} ?>" />
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="<?php if(isset($bannerinfo['banner_image'])){echo DOMAIN.'uploads/'.$bannerinfo['banner_image'];} ?>" id="profile" width="200" height="80"/>
                ...
                <div class="form-group">
                  ...
                  <img src="<?php if(isset($bannerinfo['banner_front_image'])){echo DOMAIN.'uploads/'.$bannerinfo['banner_front_image'];} ?>" id="tprofile" width="200" height="80"/>
			...
			?>
                ...
                <button type="submit" class="btn btn-primary" value="new" name="btnAdd">Save and Add New</button>
                 <a class="btn btn-default" href="<?php echo DOMAIN.'backend/home-page'; ?>">Back To List</a>
                  <?php
			}
			else if($feature=='Edit')
			{
