	...
	?>
            ...
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <a class="btn btn-block btn-primary btn-xs" href="<?php echo DOMAIN.'backend/home-page/add'; ?>"><i class="fa fa-plus"></i> Add New</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  {
					  ?>
                      <a class="btn btn-success btn-xs" title="Change Status" href="<?php echo DOMAIN.'backend/home-page/changestatus/'.$bannerlistdata['banner_id'].'/'.$bannerlistdata['status']; ?>"><i class="fa fa-unlock"></i></a>
                      <?php
				  }
				  else
				  {
					  ?>
                      <a class="btn btn-warning btn-xs" title="Change Status" href="<?php echo DOMAIN.'backend/home-page/changestatus/'.$bannerlistdata['banner_id'].'/'.$bannerlistdata['status']; ?>"><i class="fa fa-lock"></i></a>
                      <?php
				  }
				  ?>
                   </td>
                  <td>
                  <a class="btn btn-primary btn-xs" title="Edit" href="<?php echo DOMAIN.'backend/home-page/edit/'.$bannerlistdata['banner_id']; ?>"><i class="fa fa-edit"></i></a>
                  <a class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to delete this banner?');" href="<?php echo DOMAIN.'backend/home-page/delete/'.$bannerlistdata['banner_id']; ?>"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                <?php
				$cnt=$cnt+1;
